...
class RestListAdapter(val items:ArrayList<String>): RecyclerView.Adapter<RestListAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        var textView: TextView = itemView.findViewById(R.id.restTextView)
        init{
